...
bool test_a2dzeroLen();

FunctionPointer test_functions[] = { test_a2dc , test_a2dc2, test_a2dcc , test_a2dconstDeref, test_a2dsetters , test_a2dzeroLen };
